#!/usr/bin/env python3
"""Assemble src/ into the single-file portfolio at index.html.
...
out = ('<!doctype html><html lang="en"><head><meta charset="utf-8">'
       ...
       '</div></noscript>'
       '<script id="data-script">window.DATA=' + payload + ';</script>'
...
print('built %s, %d bytes' % (path, len(out.encode('utf-8'))))
